...
<template>
  <div class="login__system">
    <p class="login__title">Вход в систему</p>

    <input type="text" class="login__input login__input-username" placeholder="Логин" />
    <div class="position-relative">
      <input type="password" class="login__input login__input-password" placeholder="Пароль" />
      <svg
    ...
    <button type="button" class="login__ecp-button">Войти</button>
  </div>
</template>
...
.login__system {
  ...
  .position-relative {
    position: relative;
    margin-top: 16px; // for .login__input-password
  }
